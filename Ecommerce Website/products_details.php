...
<div class="row px-5">
    <div class="col-md-10 mt-2">
        ...
        <div class="row">
            ...
            <?php
            $getproduct = $product->showproduct_details($id);
            if ($getproduct) {
            ...
            ?>
                    <div class="col-md-4 mt-2">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <a href="index.php?cart=<?php echo $productrow['product_id']; ?>" class="btn btn-info">Add to Cart</a>
                    ...
                    <div class="col md 8">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <img style="width:300px" src="./admin/images/<?php echo $productrow['image_two']; ?>" alt="">
                            </div>
                            <div class="col-md-6">
                                <img style="width:300px" src="./admin/images/<?php echo $productrow['imge_three']; ?>" alt="">
                            </div>
                        </div>
                    </div>
            <?php
